---
id: version-0.0.1-M11-scalacheck
...
### SBT
```scala
libraryDependencies +=  "com.disneystreaming" %% "weaver-scalacheck" % "0.0.1-M11" % Test
```
...
object test extends Tests {
  def ivyDeps = Agg(
    ivy"com.disneystreaming::weaver-scalacheck:0.0.1-M11"
  )
}
```
