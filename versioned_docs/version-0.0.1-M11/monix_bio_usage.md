---
id: version-0.0.1-M11-monix_bio
...
### SBT
```scala
libraryDependencies +=  "com.disneystreaming" %% "weaver-monix-bio" % "0.0.1-M11" % Test
...
object test extends Tests {
  def ivyDeps = Agg(
    ivy"com.disneystreaming::weaver-monix-bio:0.0.1-M11"
  )
